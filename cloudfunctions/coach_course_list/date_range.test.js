...
const { businessYearMonth, rangeForCurrentMonth, rangeForCurrentThreeMonths } = require('./date_range')
...
assert.deepStrictEqual(rangeForCurrentMonth(new Date('2026-06-30T15:59:59.000Z')), { month: '2026-06', start: '2026-06-01 00:00:00', end: '2026-07-01 00:00:00' })
assert.deepStrictEqual(rangeForCurrentMonth(new Date('2026-06-30T16:00:00.000Z')), { month: '2026-07', start: '2026-07-01 00:00:00', end: '2026-08-01 00:00:00' })
assert.deepStrictEqual(rangeForCurrentMonth(new Date('2026-12-31T16:00:00.000Z')), { month: '2027-01', start: '2027-01-01 00:00:00', end: '2027-02-01 00:00:00' })
